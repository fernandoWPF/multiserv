<div class="container-fluid div-sections">
    <article class="row dedetizacao-group enter-left-bounce">
        <div class="wrapper">
    ...
    <article class="row dedetizacao-group enter-left-bounce">
        <div class="wrapper">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <h3>BARATAS</h3>
                <p class="tagline text-justify">As baratas que são animais gregários de hábitos noturnos, podem ser encontradas nos mais diversos ambientes ao redor do mundo, exceto nas regiões polares. São consideradas como os organismos de maior capacidade adaptativa e resistência do Reino Animal.</p>
                <p class="tagline text-justify">Elas podem ser agentes disseminadores de microrganismos, por exemplo, transportando bactérias causadoras de gastroenterites e surtos diarreicos. Além disso, elas podem conter certos protozoários e outros microrganismos dentro de seu corpo, eventualmente provocando doenças.</p>
                <p class="tagline text-justify">As baratas desenvolvem-se por metamorfose gradual apresentando os estádios de ovo, ninfa e adulto. Este ciclo de desenvolvimento depende de fatores como a espécie, as condições de temperatura e umidade, disponibilidade de alimentos, entre outros.</p>
                <span class="h3 text-primary">O que causam?</span>
                <p class="tagline text-justify">Disseminam bactérias que contaminam pessoas e ambientes</p>
                <p class="tagline text-justify">As baratas adquirirem agentes patogênicos por viverem e se alimentarem em latrinas, fossas, esgotos, lixo, cadáveres, etc., e os veiculam por suas fezes, secreções, ao morrerem, ou simplesmente na sua locomoção, quando germes podem cair de suas patas ou corpo, podendo transportar cerca de 40 bactérias patogênicas diferentes, das quais 25 são Enterobacteriaceae, organismos responsáveis por gastrenterites no homem. Esses insetos podem também ser hospedeiros intermediários de helmintos patogênicos (vermes) e carregar ovos e larvas, além de vírus, protozoários e fungos.</p>
    ...
    <article class="row dedetizacao-group enter-left-bounce">
        <div class="wrapper">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <h3>FORMIGAS</h3>
                <p class="tagline text-justify">As formigas são animais pertencentes à família Formicida, o grupo mais numeroso dentre os insetos. São seres particularmente interessantes porque formam níveis avançados de sociedade, ou seja, a eusocialidade.</p>
                <p class="tagline text-justify">As formigas são úteis porque podem ajudar a exterminar outros insetos daninhos e a aerificar o solo. Por outro lado, podem tornar-se uma praga quando invadem as casas, jardins e campos de cultivo. As “formigas-carpinteiras” destroem a madeira furando-a para fazer os seus ninhos.</p>
                <p class="tagline text-justify">Algumas espécies, chamadas “formigas-assassinas”, têm a tendência de atacar animais muito maiores que elas, quer para se alimentarem, quer para se defenderem. É raro atacarem o homem, mas podem dar picadas muito dolorosas e, se forem em grandes números, podem causar dano permanente ou matar por alergia grave.</p>
                <span class="h3 text-primary">O que causam?</span>
                <p class="tagline text-justify">“Perigosas” carregam bactérias e fungos.</p>
    ...
    <article class="row dedetizacao-group enter-left-bounce">
        <div class="wrapper">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <h3>CUPINS</h3>
                <p class="tagline text-justify">Cupins podem ser encontrados em quase todo o mundo, mas estão distribuídos principalmente em regiões tropicais e subtropicais. A fonte alimentar básica destes insetos é material celulósico, que em termos gerais, é digerido com o auxílio de microrganismos simbiontes intestinais.</p>
                <p class="tagline text-justify">Eles têm importante papel ecológico, funcionando como consumidores primários e decompositores, auxiliando na aeração dos solos e na distribuição de nutrientes.</p>
                <span class="h3 text-primary">O que causam?</span>
                <p class="tagline text-justify">Atacam móveis e estruturas de madeira.O Inimigo secreto. Na maioria das vezes os cupins ficam ocultos quando se descobre o prejuízo já é muito grande.</p>
                <p class="tagline text-justify">Na área urbana, estabelecem colônias em lajes, paredes duplas, subsolos e diversos outros locais. Se não forem detectados e eliminados rapidamente, estes pequenos insetos podem causar grandes prejuízos econômicos e até desabamento de estruturas.</p>
